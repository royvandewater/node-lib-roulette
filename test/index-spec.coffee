_ = require 'lodash'
SimpleRoulette = require '../index'

describe 'SimpleRoulette', ->
  describe 'the pockets', ->
    beforeEach ->
      @sut = new SimpleRoulette
  ...
  describe '->bet', ->
    beforeEach ->
      @sample = sinon.stub()
      @sut = new SimpleRoulette sample: @sample
    ...
    describe 'when bet is called a negative bet', ->
      it 'should throw an exception', ->
        expect(=> @sut.bet(-1)).to.throw Error
    ...
    describe 'when sample returns red', ->
      ...
      describe 'when bet is called with 1 on green', ->
        beforeEach ->
          @result = @sut.bet 1, on: 'green'
